...
<body style=" background: linear-gradient(to right, #000012, #6c6c6c);">                    
    ...
    <h3 class="form_auth_block_head_text" style="margin: 80px auto;  text-align: center; color: white;" >Вход в панель администатора</h3>
    <form class="form_auth_style" action="admenter.php" method="post" style="margin: 80px auto; width: 300px;">
